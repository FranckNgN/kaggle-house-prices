...
if __name__ == "__main__":
    ...
    validate_predictions_wrapper(test_pred_log, "RandomForest", target_is_log=True)
    ...
    validate_submission_wrapper(submission, len(test), "RandomForest", test_ids=submission["Id"])
